...
Проведение A/B – теста для оценки работы нового алгоритма рекомендаций постов. Использованы t-тест, u-тест Манна-Уитни, тесты поверх бакетного преобразования, Cuped t-тест, Пуассоновский бутстреп.
